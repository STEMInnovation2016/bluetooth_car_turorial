...
Serial.println("Enter 'i' to move forward");
Serial.println("Enter 'k' to reverse");
Serial.println("Enter 'j' to turn left");
Serial.println("Enter 'l' to turn right");
Serial.println("Enter 'space' to stop");
Serial.println("Enter '8' to open the hatch");
Serial.println("Enter '9' to close the hatch");
